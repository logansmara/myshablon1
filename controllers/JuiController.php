...
class JuiController extends \yii\web\Controller
{
    ...
    public function actionDraggableAjax()
    {
        $moves = Move::find()->all();
        if(\Yii::$app->request->isAjax){
        $id = \Yii::$app->request->get('id');
        $pagex = \Yii::$app->request->get('left');
        $pagey = \Yii::$app->request->get('top');
        ...
        return $this->render('draggable-ajax', compact('moves'));
    }
    ...
    public function actionUpdateAjax()
    {
        ...
        */
        ...
        // перенаправляет снова на страницу jui/draggable
        return Yii::$app->response->redirect(['jui/draggable-ajax']);
    }
